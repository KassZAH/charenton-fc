-- Roadmap V3, Macro-release B (Lot 19) — enregistrer player_restrictions
-- dans export_backup_snapshot(), même geste que 20260722000800 pour
-- match_squad_entries (Lot 17) : toute nouvelle table doit être ajoutée ici
-- ET dans BACKUP_TABLES (src/lib/data/backups.ts) dans le même lot, jamais
-- après coup.
--
