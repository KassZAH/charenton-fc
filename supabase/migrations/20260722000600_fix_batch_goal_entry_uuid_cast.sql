-- Roadmap V3, Lot 18 — correctif découvert en testant insert_goals_batch
-- avant d'écrire le code applicatif : nullif(jsonb->>'player_id', '')
-- retourne du texte, jamais implicitement converti en uuid par Postgres
-- dans un INSERT/UPDATE ciblant une colonne uuid — chaque occurrence doit
-- être castée explicitement.
